...
System-wide administration and operations UI for the Moodle FlexAccess ecosystem (dashboard, account browsing, admin conversion, mail queue, category policies, campaigns and invitations). Maturity: Beta (0.9.x).
