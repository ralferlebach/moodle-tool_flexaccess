...
$string['batch:createdqueued'] = 'The batch for {$a} accounts has been queued. The accounts are being created in the background; reload this page to follow the progress.';
...
$string['batch:issueconfirm'] = 'This issues a fresh set of passwords for all still-managed accounts in this batch and invalidates any previously issued credentials. Accounts that have already been converted to permanent accounts are not affected. Continue?';
$string['batch:issuecredentials'] = 'Issue batch credentials';
$string['batch:members'] = 'Accounts';
$string['batch:name'] = 'Batch name';
$string['batch:notreadyyet'] = 'This batch is still being created. Please wait until provisioning has finished before issuing credentials.';
$string['batch:openincourse'] = 'Open in the course';
$string['batch:passwordlength'] = 'Password length';
$string['batch:progress'] = '{$a->done} of {$a->total}';
$string['batch:requestcount'] = 'Number of participants';
...
$string['batch:statuscomplete'] = 'Complete';
$string['batch:statuscreating'] = 'Being created';
$string['batch:statusfailed'] = 'Failed';
$string['batch:statusqueued'] = 'Queued';
...
$string['batchrequest:body'] = '{$a->requester} has requested an anonymous access list of {$a->count} accounts for the course "{$a->course}". Use the link to create it.';
$string['batchrequest:small'] = '{$a->requester} requested {$a->count} access accounts for "{$a->course}".';
$string['batchrequest:subject'] = 'Access list requested for "{$a}"';
...
$string['invite:invalidemails'] = 'These addresses are not valid: {$a}. Please correct or remove them.';
...
$string['invite:revokefailed'] = 'This invitation could not be revoked (it may already have been accepted, revoked, or is being accepted right now).';
