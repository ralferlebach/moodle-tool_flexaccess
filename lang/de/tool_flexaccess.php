...
$string['batch:createdqueued'] = 'Der Batch mit {$a} Konten wurde eingeplant. Die Konten werden im Hintergrund erstellt; laden Sie die Seite neu, um den Fortschritt zu verfolgen.';
...
$string['batch:issueconfirm'] = 'Hiermit werden für alle noch verwalteten Konten dieses Batches neue Passwörter ausgestellt; zuvor ausgestellte Zugangsdaten werden ungültig. Bereits in dauerhafte Konten umgewandelte Konten sind nicht betroffen. Fortfahren?';
$string['batch:issuecredentials'] = 'Zugangsdaten ausstellen';
$string['batch:members'] = 'Konten';
$string['batch:name'] = 'Stapelname';
$string['batch:notreadyyet'] = 'Dieser Batch wird noch erstellt. Bitte warten Sie das Ende der Bereitstellung ab, bevor Sie Zugangsdaten ausstellen.';
$string['batch:openincourse'] = 'Im Kurs öffnen';
$string['batch:passwordlength'] = 'Passwortlänge';
$string['batch:progress'] = '{$a->done} von {$a->total}';
$string['batch:requestcount'] = 'Anzahl der Teilnehmer/innen';
...
$string['batch:status'] = 'Status';
$string['batch:statuscomplete'] = 'Fertig';
$string['batch:statuscreating'] = 'Wird erstellt';
$string['batch:statusfailed'] = 'Fehlgeschlagen';
$string['batch:statusqueued'] = 'Eingeplant';
...
$string['batchrequest:body'] = '{$a->requester} hat für den Kurs „{$a->course}" eine anonyme Zugangsliste mit {$a->count} Konten angefordert. Über den Link können Sie sie erstellen.';
$string['batchrequest:small'] = '{$a->requester} hat {$a->count} Zugangskonten für „{$a->course}" angefordert.';
$string['batchrequest:subject'] = 'Zugangsliste für „{$a}" angefordert';
...
$string['invite:invalidemails'] = 'Diese Adressen sind ungültig: {$a}. Bitte korrigieren oder entfernen.';
...
$string['invite:revokefailed'] = 'Diese Einladung konnte nicht widerrufen werden (sie wurde möglicherweise bereits angenommen, widerrufen oder wird gerade angenommen).';
